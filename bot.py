...
async def photo_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    hashtag_reactions = {
        ...
        "#икра": ["Я б его мпрегнул", "МЯУ", "Ну какой же он восхитительный...", "Он прекрасен", "Молюсь на Рафаэля", "Я на него всю жизнь бы работал, лишь бы быть рядом и смотреть на него...", "Божественно красивый", "Ни с чем не сравнимый", "Я б ему дал."],
        "#инцестит": ["Всё прекрасно, но не хватает кабачка...", "Ну какой сладкий кабачок 🥰", "Я б его мпрегнул", "Да я не ебу, что тут говорить. Госпожа Капучино нихуя мне объяснила."],    
